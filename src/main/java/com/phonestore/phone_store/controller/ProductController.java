...
public class ProductController {
    ...
    public List<Product> getAllProducts(@RequestParam(defaultValue = "0") int pageNumber,
       ...
       List<Product> result = productService.getAllProduct(pageNumber, searchKey);
        System.out.println("The result size is " + result);
        return result;
    }
    ...
    public List<Product> getProductDetails(@PathVariable("isSingleProductCheckOut") boolean isSinglePProductCheckOut,
                                  @PathVariable("productId") Integer productId) {
        return productService.getProductDetails(isSinglePProductCheckOut, productId);
    }
